...
%------------------------------------------------------------
\newpage
\section*{\color{red} The Commercial Opportunity}  % (recommended length: 2-4 pages)
...
Insert.
%This section describes: a market assessment, the potential customers, and the requirements for implementing the commercialization process.




%------------------------------
%\subsection*{\color{red} Commercialization Resources}
%------------------------------

%Strategies for commercializing the TURN system were developed through participation with several different resources.  These programs helped establish: a clear understanding of potential markets, an assessment of technology applications, a survey of the competitive landscape, and a profile of target customers.


%------------------------------
%{\color{red} \bf Technology Acceleration Program:}
%The Small Business Innovative Research Technology Acceleration Program (SBIR TAP), is sponsored by the Air Force Research Laboratory Small Business Office (AFRL/SB), and is managed by The Entrepreneurs Center, Inc., a technology accelerator located in Dayton, Ohio.  The SBIR TAP program is a six-month long program that provided Gradient comprehensive commercialization training, including significant market analysis, which provided a foundation for this commercialization plan.


%------------------------------
%{\color{red} \bf Treble One Aerospace Consulting:}
%Marketing and business development professionals, also located in Dayton, Ohio, who focus exclusively on Air Force related research performed at Wright-Patterson AFB.  Treble One has a strong track record of success in the SBIR Commercialization Readiness Program (CRP), Rapid Innovation Fund (RIF), and SBIR Phase III programs.  They have experience with cross-transferring technology to other DoD components, and have already offered Gradient networking connections with UAV manufacturers and aircraft propulsion development and integration specialists.


%------------------------------
%{\color{red} \bf Peninsula Technology Incubator:}
%Ideally situated within the National Institute of Aerospace (NIA), in Hampton, VA, the Peninsula Technology Incubator (PTI) is a program designed to leverage research experience from NASA Langley, and focuses exclusively on unmanned system development and commercialization.  Their process utilizes a customer driven technology development methodology, originally pioneered at MIT.  Gradient can leverage facilities for both rapid prototyping and flight testing, and PTI is well connected with both Virginia government officials and the 757 Angels, a local technology angel investing group.
...
%------------------------------
{\color{red} \bf Technical Challenges:}
...
%------------------------------
{\color{red} \bf Competitive Landscape:}
...
%------------------------------
\subsection*{\color{red} Three Ideal Market Demographics}
%------------------------------

To better understand the customers who may benefit from a TURN system, a detailed market analysis was conducted, based on the techniques developed during participation in the SBIR TAP program.  This analysis considered other solutions available, and clearly identified specific market ``niches'' within the UAS space for which a TURN solution offers significant advantage over current offerings.  Through this analysis, a phased market entry approach is the preferred pathway to broad transition and commercialization.  This plan leverages the spiral development process, where several prototype milestones are anticipated to serve the needs of different and unique demographics.


%------------------------------
{\color{red} \bf Battery Powered Remote Deployment:}
There is already an existing market for small-scale, battery-power, fixed wing drones.  Examples of such environments include first-responder incident monitoring, precision agriculture, infrastructure inspection, construction and surveying, and mobile ISR applications for ground troops.  While current solutions support five pound payloads for a 90 minute flight operation, a comparable-sized TURN system is anticipated to offer VTOL capabilities with a 4-7 hour endurance.  Early prototypes within the spiral development process already mirror the desired size to service this customer.  Therefore, the first planned deployment of the TURN system will address this preexisting market segment, and implement an accelerated commercialization strategy.


%------------------------------
{\color{red} \bf Medium-Altitude Ultra-Endurance Combustion Engine:}
This scale system is the focus of the proposed SBIR research, performed for the Air Force and its primary customer.  While the current intention is for long-term ISR missions, other applications include: border patrol, large scale disaster monitoring, and environmental wildlife observations.  Existing combustion engine embodiments can support payloads of a few hundred pounds for a few days at a time.  The Phase I research results indicate that a TURN system with a comparable footprint, should be capable of exceeding a thirty-day flight endurance, while carrying 250 pounds of payload, and supplying 2000 watts of power.


%------------------------------
{\color{red} \bf Solar Regenerative Persistently Enduring Flight:}
Prior to considering a combustion engine TURN embodiment for the specified Air Force mission, the original goal for the TURN concept was to attain persistently enduring flight.  This system will operate within the stratosphere and use solar cells on the wing surfaces to collect enough energy each day to sustain flight for an indefinite period of time.  Research from the PhD and from this Phase I effort both show great promise for attaining the goal with a 100 pound payload drawing 1000 watts of power, while operating over a wide range of latitudes and day-of-year.  Facebook and Google have been actively working on this feat to provide internet to remote parts of the globe, but both companies have experienced severe setbacks with traditional tube-and-wing aircraft designs.  Aside from broadband speed internet access, this capability could also serve as a GPS-disabled alternative, a communication relay station, and an atmospheric weather monitoring platform.




%------------------------------
\subsection*{\color{red} Target Customers}
%------------------------------
...
%------------------------------------------------------------
\section*{\color{green} The Innovation}  % (recommended length: 1-3 pages)
...
%------------------------------
\subsection*{\color{green} Radical New Concept Approach}
%------------------------------
...
%------------------------------
{\color{green} \bf Hover Operation:}
...
%------------------------------
{\color{green} \bf Flight Operation:}
...
%------------------------------
{\color{green} \bf Vertical Translation:}
...
%------------------------------
{\color{green} \bf Horizontal Translation:}
...
%------------------------------
{\color{green} \bf Vertical Takeoff and Landing:}
...
%------------------------------
\subsection*{\color{green} System Benefits}
%------------------------------
...
%------------------------------
{\color{green} \bf Centrifugal Stiffening:}
...
%------------------------------
{\color{green} \bf Combustion Engine Ultra-Endurance UAV:}
...
%------------------------------------------------------------
\section*{\color{green} The Company/Team}  % (recommended length: 1-3 pages)
...
%------------------------------------------------------------
\section*{\color{green} Technical Discussion and R\&D Plan}  % (minimum length: 5 pages, recommended length: 5-7 pages)
...
%------------------------------
\subsection*{\color{green} Spiral Development Plan}
%------------------------------
...
%------------------------------
{\color{green} \bf Custom Avionics Platform [Mark 0]:}
...
%------------------------------
{\color{green} \bf Multibody Dynamics Validation [Mark 1]:}
...
%------------------------------
{\color{green} \bf Aerodynamic Model Refinement [Mark 2]:}
...
%------------------------------
\subsection*{\color{green} Multibody Dynamics Validation}
%------------------------------
